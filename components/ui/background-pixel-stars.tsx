/**
 * 21st.dev Background Pixel Stars (UI Capsule).
 * https://21st.dev/@uicapsule/components/background-pixel-stars
 * Official copy-prompt source (registry CLI was membership-gated).
 */
"use client"
