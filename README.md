...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 441 board services,
...
npm run migrate   # apply migrations + seed the 441 services, then exit
