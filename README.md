...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 111 board services,
...
npm run migrate   # apply migrations + seed the 111 services, then exit
