...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 331 board services,
...
npm run migrate   # apply migrations + seed the 331 services, then exit
