...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 251 board services,
...
npm run migrate   # apply migrations + seed the 251 services, then exit
