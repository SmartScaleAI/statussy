...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 411 board services,
...
npm run migrate   # apply migrations + seed the 411 services, then exit
