...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 191 board services,
...
npm run migrate   # apply migrations + seed the 191 services, then exit
