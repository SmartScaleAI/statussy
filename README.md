...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 281 board services,
...
npm run migrate   # apply migrations + seed the 281 services, then exit
