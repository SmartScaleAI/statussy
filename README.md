...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 351 board services,
...
npm run migrate   # apply migrations + seed the 351 services, then exit
