...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 475 board services,
...
npm run migrate   # apply migrations + seed the 475 services, then exit
