...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 461 board services,
...
npm run migrate   # apply migrations + seed the 461 services, then exit
