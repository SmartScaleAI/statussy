...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 401 board services,
...
npm run migrate   # apply migrations + seed the 401 services, then exit
