...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 271 board services,
...
npm run migrate   # apply migrations + seed the 271 services, then exit
