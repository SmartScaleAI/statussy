...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 241 board services,
...
npm run migrate   # apply migrations + seed the 241 services, then exit
