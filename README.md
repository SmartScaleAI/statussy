...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 151 board services,
...
(Square, Paddle, Chargebee, Recurly, Klarna, Plaid, GoCardless), and Stripe
...
npm run migrate   # apply migrations + seed the 151 services, then exit
