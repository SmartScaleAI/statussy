...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 471 board services,
...
npm run migrate   # apply migrations + seed the 471 services, then exit
