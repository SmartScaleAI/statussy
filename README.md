...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 361 board services,
...
npm run migrate   # apply migrations + seed the 361 services, then exit
