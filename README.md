...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 485 board services,
...
npm run migrate   # apply migrations + seed the 485 services, then exit
