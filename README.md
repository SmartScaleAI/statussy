...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 421 board services,
...
npm run migrate   # apply migrations + seed the 421 services, then exit
