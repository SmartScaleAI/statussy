...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 91 board services,
...
Upstash, Pinecone, MongoDB, CockroachDB, Prisma), and Neon via Status.io
...
npm run migrate   # apply migrations + seed the 91 services, then exit
...
```ts
{
  id: "service-id",
  name: "Service Name",
  category: "ai", // or "cloud" | "developer" | "data"
