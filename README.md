...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 311 board services,
...
npm run migrate   # apply migrations + seed the 311 services, then exit
...
```ts
{
  id: "service-id",
  name: "Service Name",
  category: "ai", // or "cloud" | "developer" | "data" | "auth" | "payments" | "observability" | "email" | "design" | "infra"
