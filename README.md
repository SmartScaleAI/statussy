...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 460 board services,
...
npm run migrate   # apply migrations + seed the 460 services, then exit
