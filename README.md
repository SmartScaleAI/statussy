...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 381 board services,
...
npm run migrate   # apply migrations + seed the 381 services, then exit
