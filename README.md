...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 321 board services,
...
npm run migrate   # apply migrations + seed the 321 services, then exit
