...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 451 board services,
...
npm run migrate   # apply migrations + seed the 451 services, then exit
