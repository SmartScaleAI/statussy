...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 431 board services,
...
npm run migrate   # apply migrations + seed the 431 services, then exit
