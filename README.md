...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 481 board services,
...
npm run migrate   # apply migrations + seed the 481 services, then exit
