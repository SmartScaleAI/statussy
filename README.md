...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 101 board services,
...
InfluxDB, Couchbase, Confluent, Tinybird, Zilliz), and Databricks via
Status.io
...
npm run migrate   # apply migrations + seed the 101 services, then exit
