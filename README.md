...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 211 board services,
...
Embrace), and Dash0 via `https://dash0status.com` (the public host
  ...
  `https://resend-status.com` (the public host redirects), and Customer.io
...
npm run migrate   # apply migrations + seed the 211 services, then exit
