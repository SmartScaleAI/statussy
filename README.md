...
`service_snapshots`, `components`, `incidents`, `service_suggestions`), seeds the 391 board services,
...
npm run migrate   # apply migrations + seed the 391 services, then exit
